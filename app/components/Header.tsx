          ...
          <div className="flex items-center gap-4 md:gap-6">
            ...
            {user?.isAdvocate && (
              <>
                ...
                <button onClick={() => router.push('/clients')} className="text-sm font-medium text-slate-600 hover:text-emerald-600 transition hidden md:block">Clients</button>
                {user?.isAdmin && (
                  <>
                    <button onClick={() => router.push('/management')} className="text-sm font-medium text-slate-600 hover:text-emerald-600 transition hidden md:block">Management</button>
                    <button onClick={() => router.push('/admin/incentives')} className="text-sm font-medium text-slate-600 hover:text-emerald-600 transition hidden md:block">Incentives</button>
                  </>
                )}
